...
class BrowserFrame(tk.Frame):
    ...
    def get_url(self):
        if self.browser:
            return self.browser.GetUrl(), self.url
        else:
...
class LoadHandler(object):
    ...
    def OnLoadError(self, browser, frame, error_code, error_text_out, failed_url):
        """ """
        print(f"OnLoadError: browser url={browser.GetUrl()}")
        print(f"OnLoadError: frame url={frame.GetUrl()}")
        print(f"OnLoadError: error_code={error_code}")
        print(f"OnLoadError: error_text_out={error_text_out}")
        print(f"OnLoadError: failed_url={failed_url}")
        if failed_url:
            self.browser_frame.url = failed_url
