...
# print('Welcome to ifv community. Official Website: http://www.hlht2013.org')
...
class str(str):
    def divide(self, amount=2):
        ...
        for i in range(amount):
            if i == amount-1:
                final.append(str(self[round(num):]))
            else:
                final.append(str(self[round(num):round(num+len(self)/amount)]))
            num += len(self)/amount
        return final
